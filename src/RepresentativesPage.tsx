...
export default function RepresentativesPage() {
  ...
  return <main className="page-shell representatives-page">
    ...
    <section className="representatives-hero" aria-labelledby="representatives-title"><img src={BANNER_PLACEHOLDER} alt="Espaço reservado para banner" /><div><p className="editorial-eyebrow">Representantes</p><h1 id="representatives-title">Presença que <em>aproxima.</em></h1><p>Encontre o representante Tempus mais próximo do seu projeto.</p><a className="editorial-action editorial-action--light" href="#finder">Encontrar representante <span>↗</span></a></div></section>
