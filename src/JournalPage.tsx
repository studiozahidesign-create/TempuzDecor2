...
export default function JournalPage() {
  ...
  return <main className="page-shell journal-page">
    ...
    <section className="journal-hero" aria-labelledby="journal-title"><img src="/images/products/3465-lille-2.jpg" alt="Interior contemporâneo com mobiliário e luz natural" /><div><p className="editorial-eyebrow">Conteúdos</p><h1 id="journal-title">Design para além do <em>produto.</em></h1><p>Ideias, referências e conversas sobre design, arquitetura, tecnologia e novas formas de viver.</p><article><span>Interiores / 18.08.2026</span><h2>Design, matéria e o espaço que habitamos.</h2><a className="editorial-action editorial-action--light" href="/conteudos/conforto-como-parte-do-projeto">Ler artigo <span>↗</span></a></article></div></section>
    ...
    <section className="journal-feature" aria-labelledby="feature-title"><img src="/images/products/7394-martina.png" alt="Ambiente de criação com materiais e arquitetura contemporânea" /><div><p className="editorial-eyebrow">Em foco</p><h2 id="feature-title">O design começa muito antes do <em>produto.</em></h2><p>Uma investigação sobre processos, materiais, tecnologia e as decisões que transformam uma ideia em objeto.</p><a className="editorial-action editorial-action--light" href="#newsletter">Explorar história <span>↗</span></a></div></section>
