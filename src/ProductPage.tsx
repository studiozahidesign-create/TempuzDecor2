...
const gallery = [
  ["Frontal", "/images/products/5841-mille-3-2.jpg", "Vista frontal da poltrona Mille"],
  ["Lateral", "/images/products/7041-athenas.png", "Vista lateral de poltrona com estrutura metálica"],
  ["Traseira", "/images/products/6379-aurora.png", "Vista traseira de poltrona em madeira"],
  ["Reclinada", "/images/products/7187-amora.png", "Poltrona reclinável em posição de descanso"],
  ["Detalhe", "/images/products/6371-sophi-taupe.png", "Detalhe de couro matelassê"],
  ["Ambiente", "/images/products/7041-athenas.png", "Poltrona em ambiente de estar contemporâneo"],
] as const;
...
export default function ProductPage() {
  ...
  return <main className="page-shell product-page">
    ...
    <section className="product-lifestyle"><img src="/images/products/7400-ayla.png" alt="Poltrona em uma sala de estar ampla e contemporânea" /><img src="/images/products/7032-maya-cor-granizo.png" alt="Interior neutro com peças de design" /></section>

    <section className="product-related" aria-labelledby="related-products-title"><header><p className="editorial-eyebrow editorial-eyebrow--dark">Continue explorando</p><h2 id="related-products-title">Peças que conversam<br /><em>com a Mille.</em></h2></header><div>{[["Living", "Athenas", "/images/products/7041-athenas.png"], ["Essence", "Lina", "/images/products/6639-donna.webp"], ["Dreams", "Amora", "/images/products/7187-amora.png"], ["Office", "Nora", "/images/products/7398-sila.png"]].map(([collection, name, image]) => <a href="/produtos/mille" key={name}><img src={image} alt={`Poltrona ${name}`} /><p>{collection}</p><h3>{name}</h3><span>Ver produto →</span></a>)}</div></section>
