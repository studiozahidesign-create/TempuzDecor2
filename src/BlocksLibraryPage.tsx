...
const blocksProducts: BlocksProduct[] = [
  { name: "Mille", category: "Poltronas reclináveis", type: "Poltrona", reference: "MIL-01", image: "/images/products/5841-mille-3-2.jpg", description: "Poltrona reclinável com conforto integrado para ambientes contemporâneos.", available_formats: ["SKP", "3DS", "OBJ"], download_links: {}, featured: true, searchable: true, order: 1 },
  { name: "Athenas", category: "Living", type: "Poltrona", reference: "ATH-02", image: "/images/products/7041-athenas.png", description: "Poltrona de presença leve, desenvolvida para áreas de estar.", available_formats: ["SKP", "DWG", "OBJ"], download_links: {}, featured: true, searchable: true, order: 2 },
  { name: "Amora", category: "Living", type: "Sofá", reference: "AMO-03", image: "/images/products/7187-amora.png", description: "Sofá modular para composições de convivência e permanência.", available_formats: ["SKP", "FBX"], download_links: {}, featured: false, searchable: true, order: 3 },
  { name: "Ayla", category: "Living", type: "Poltrona", reference: "AYL-04", image: "/images/products/7400-ayla.png", description: "Peça compacta com proporção pensada para diferentes ambientes.", available_formats: ["3DS", "DWG", "OBJ"], download_links: {}, featured: false, searchable: true, order: 4 },
  { name: "Nora", category: "Dormitórios", type: "Cadeira", reference: "NOR-05", image: "/images/products/7398-sila.png", description: "Cadeira de apoio para espaços de descanso e leitura.", available_formats: ["SKP", "3DS"], download_links: {}, featured: false, searchable: true, order: 5 },
  { name: "Pérola", category: "Dormitórios", type: "Cama", reference: "PER-06", image: "/images/products/5777-cama-julia.webp", description: "Cama de linhas acolhedoras para projetos de dormitório.", available_formats: ["SKP", "DWG", "FBX"], download_links: {}, featured: true, searchable: true, order: 6 },
  { name: "Lina", category: "Acessórios", type: "Cadeira", reference: "LIN-07", image: "/images/products/7346-ada-2.png", description: "Cadeira de desenho essencial para composições versáteis.", available_formats: ["OBJ", "3DS"], download_links: {}, featured: false, searchable: true, order: 7 },
  { name: "Siena", category: "Poltronas reclináveis", type: "Poltrona", reference: "SIE-08", image: "/images/products/7398-sila.png", description: "Poltrona de volume generoso para o conforto cotidiano.", available_formats: ["SKP", "OBJ", "FBX"], download_links: {}, featured: false, searchable: true, order: 8 },
